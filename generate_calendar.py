...
def is_retail(text):
    return text.startswith("retail sales")
...
def classify_event(currency, name):
    ...
    if currency == "EUR":
        ...
        if (
            ...
            return "ECB_PRESS", "ECB Press Conference"
        ...
        if has_any(text, [
            ...
            return "ECB_RATE", "ECB Rate Decision"
    ...
    if currency == "GBP":
        ...
        if has_any(text, [
            ...
            return "BOE_RATE", "BoE Rate Decision"
    ...
    if currency == "JPY":
        ...
        if (
            ...
            return "BOJ_PRESS", "BoJ Press Conference"
    ...
    if currency == "CHF":
        ...
        if has_any(text, [
            ...
            return "SNB_RATE", "SNB Rate Decision"
        ...
        if (
            ...
            return "SNB_PRESS", "SNB Press Conference"
    ...
    if currency == "CAD":
        ...
        if has_any(text, [
            ...
            return "BOC_RATE", "BoC Rate Decision"
        ...
        if (
            ...
            return "BOC_PRESS", "BoC Press Conference"
    ...
    if currency == "AUD":
        ...
        if has_any(text, [
            ...
            return "RBA_RATE", "RBA Rate Decision"
        ...
        if (
            ...
            return "RBA_PRESS", "RBA Press Conference"
    ...
    if currency == "NZD":
        ...
        if has_any(text, [
            ...
            return "RBNZ_RATE", "RBNZ Rate Decision"

        if re.search(r"\bocr\b", text):
            return "RBNZ_RATE", "RBNZ Rate Decision"
        ...
        if (
            ...
            return "RBNZ_PRESS", "RBNZ Press Conference"
    ...
    if currency == "EUR":
        ...
        if is_cpi(text):
            return "EUR_CPI", "Eurozone Flash CPI"

        if is_gdp(text):
            return "EUR_GDP", "Eurozone Flash GDP"

        if is_pmi(text):
            return "EUR_PMI", "Eurozone Flash PMI"
    ...
    if currency == "GBP":
        ...
        if has_any(text, [
            ...
            return "GBP_JOBS", "UK Labour Market"

        if is_gdp(text):
            return "GBP_GDP", "UK GDP First Estimate"

        if is_pmi(text):
            return "GBP_PMI", "UK Flash PMI"

        if is_retail(text):
            return "GBP_RETAIL", "UK Retail Sales"
    ...
    if currency == "JPY":
        ...
        if is_cpi(text):
            ...
            if "tokyo" in text:
                return "JPY_TOKYO_CPI", "Tokyo CPI"

            return "JPY_CPI", "Japan CPI"

        if is_gdp(text):
            return "JPY_GDP", "Japan GDP"
    ...
    if currency == "CHF":
        ...
        if is_cpi(text):
            return "CHF_CPI", "Swiss CPI"

        if is_gdp(text):
            return "CHF_GDP", "Swiss GDP"
    ...
    if currency == "CAD":
        ...
        if is_cpi(text):
            return "CAD_CPI", "Canada CPI"

        if has_any(text, [
            "employment change",
            "unemployment rate",
        ]):
            return "CAD_JOBS", "Canada Jobs"

        if is_gdp(text):
            return "CAD_GDP", "Canada GDP"

        if is_retail(text):
            return "CAD_RETAIL", "Canada Retail Sales"
    ...
    if currency == "AUD":
        ...
        if is_cpi(text):
            return "AUD_CPI", "Australia CPI"

        if has_any(text, [
            "employment change",
            "unemployment rate",
        ]):
            return "AUD_JOBS", "Australia Jobs"

        if is_gdp(text):
            return "AUD_GDP", "Australia GDP"
    ...
    if currency == "NZD":
        ...
        if is_cpi(text):
            return "NZD_CPI", "New Zealand CPI"

        if has_any(text, [
            "employment change",
            "unemployment rate",
        ]):
            return "NZD_JOBS", "New Zealand Jobs"

        if is_gdp(text):
            return "NZD_GDP", "New Zealand GDP"
...
start_string = start_day.isoformat()
end_string = end_day.isoformat()
...
# IMPORTANT:
# events is created HERE, before the ONS block.
events = list(
    groups.values()
)
...
def should_keep(event):
    ...
    # Delete API UK GDP.
    # We replace it with official ONS below.
    if family == "GBP_GDP":
        return False
